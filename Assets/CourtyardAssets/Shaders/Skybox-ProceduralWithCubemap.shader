...
Shader "Skybox/ProceduralWithCubemap" {
Properties {
...
//				for(int i=0; i<int(kSamples); i++) // Loop removed because we kept hitting SM2.0 temp variable limits. Doesn't affect the image too much.
		...
		// if y < 0 [eyeRay.y > 0] - sky
			...
			half4 texMask = texCUBE(_TexMask, IN.texcoord);
			half3 cmask = DecodeHDR(texMask, _TexMask_HDR);
			//return half4(c, 1);

			return half4((col+c+c2)*cmask,1.0);
